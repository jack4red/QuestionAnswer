...
function createEmotionTable() {
    ...
    var faceVersion = "?v=1.1", //版本号
            ...
            imagePath = '/static/ueditor/dialogs/emotion/images/weixin/' //获取显示表情和预览表情的路径
    ...
    for (var i = 0; i < 7; ++i) {
        ...
        for (var j = 0; j < imgColNum; ++j) {
            ...
            if ( faceImage ) {
                ...
                textHTML.push( '<span>' );
                textHTML.push( '<img  style="background-position:' + offset + 'px 0px;" title="' + infor + '" src="/static/ueditor/dialogs/emotion/images/0.gif" width="' + iWidth + '" height="' + iHeight + '"></img>' );
                textHTML.push( '</span>' );
            } else {
